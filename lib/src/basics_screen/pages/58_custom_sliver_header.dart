...
class CustomSliverHeaderExample extends StatelessWidget {
  const CustomSliverHeaderExample({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Custom Sliver Header'),
        actions: <Widget>[
          IconButton(
