...
class AnimatedIconsExampleTwoBasics extends StatelessWidget {
  const AnimatedIconsExampleTwoBasics({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Animated Icons Example Two'),
        actions: <Widget>[
          IconButton(
            icon: Icon(Icons.code),
            onPressed: () {
              launchUrl(
                Uri.parse('https://github.com/omarSuarezRodriguez/flutter_tutorial_apps_github/blob/main/lib/src/basics_screen/pages/146_animated_icon_example_two.dart'),
              );
            },
          ),
        ],),
