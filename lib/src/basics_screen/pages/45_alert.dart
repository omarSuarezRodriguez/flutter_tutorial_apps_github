...
class AlertsExample extends StatelessWidget {
  const AlertsExample({super.key});
      ...
      appBar: AppBar(
        ...
        actions: <Widget>[
          IconButton(
            ...
            onPressed: () {
              launchUrl(
                Uri.parse('https://github.com/omarSuarezRodriguez/flutter_tutorial_apps_github/blob/main/lib/src/basics_screen/pages/45_alert.dart'),
              );
            },
          ),
        ],
