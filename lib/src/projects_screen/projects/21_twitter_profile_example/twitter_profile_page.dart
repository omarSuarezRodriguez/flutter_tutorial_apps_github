...
class TwitterProfilePageExample extends StatelessWidget {
  const TwitterProfilePageExample({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Twitter Profile Page')),
      body: const Center(
        child: TwitterProfilePage(),
      ),
    );
  }
}
                    ...
                    decoration: BoxDecoration(
                        ...
                        image: isExpanded
                            ? DecorationImage(
                                ...
                                image: NetworkImage('https://miro.medium.com/max/3200/1*mMJ3IvaAuMAmqjtyistCog.png'))
                            : null),
                    child: Align(
