...
class AnimationsPagesExampleProjects extends StatelessWidget {
  const AnimationsPagesExampleProjects({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Animations Pages')),
      body: const Center(
