...
class ShoesStorePageExample extends StatelessWidget {
  const ShoesStorePageExample({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Shoes Store Page')),
      body: const Center(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Transform.rotate(
                          ...
                          child: FittedBox(child: FlutterLogo(),fit: BoxFit.cover,),),
                    ),
                    Text(
                      shoe.name!,
                                ...
                                Center(
                                  child: Transform(
                                    ...
                                    child: Hero(
                                      ...
                                      child: Container(child: FittedBox(child: FlutterLogo(),fit: BoxFit.cover,), height: size.width / 2.5),
                                      // child: Image.asset(
                                      //   shoes[index].image!,
