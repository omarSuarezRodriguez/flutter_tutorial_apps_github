...
import 'sports_store_detail_page.dart';
...
class SportsStorePageExample extends StatelessWidget {
  const SportsStorePageExample({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('SportsStore Page')),
      body: const Center(
