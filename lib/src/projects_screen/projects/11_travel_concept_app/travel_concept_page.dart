...
class TravelConceptPageExample extends StatelessWidget {
  const TravelConceptPageExample({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Travel Concept Page')),
      body: const Center(
        child: TravelConceptPage(),
      ),
    );
  }
}
