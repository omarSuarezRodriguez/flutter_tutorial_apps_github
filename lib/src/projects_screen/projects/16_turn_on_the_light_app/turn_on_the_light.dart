...
class TurnOnTheLightExample extends StatelessWidget {
  const TurnOnTheLightExample({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Turn On The Light')),
      body: Center(
        child: TurnOnTheLight(),
      ),
    );
  }
}
